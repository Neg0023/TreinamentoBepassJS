(function(){
  ...
  */
  ...
  var person1 = new Person('João', 'Silva', 33);
  console.log(person1);
  var person2 = new Person('Maria', 'Oliveira', 55);
  console.log(person2);
  var person3 = new Person('José', 'Baptista', 68);
  console.log(person3);
  /*
  ...
  */
  ...
  console.log(person3.getFullName() + ' agora tem ' + person3.addAge(22) + ' anos.');
  })();